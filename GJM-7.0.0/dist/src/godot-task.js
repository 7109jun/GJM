...
function gdQuote(s) { return JSON.stringify(s); }
...
function wrapTaskScript(body, resultFile, major, args) {
    body = dedent(body);
...
export async function runGodotScriptTask(input) {
...
//# sourceMappingURL=godot-task.js.map
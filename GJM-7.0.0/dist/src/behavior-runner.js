...
function emitRunner3(mainScene) {
    return `extends Node
...
function emitRunnerScene(major) {
    if (major >= 4) {
...
function emitRunner4(mainScene) {
    return `extends Node
...
export async function runBehavior(projectRoot, behavior) {
...
//# sourceMappingURL=behavior-runner.js.map